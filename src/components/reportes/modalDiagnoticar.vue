      ...
      <div class="d-block text-center">
      	...
      	<div v-else>
			...
			<div role="tablist">
			    ...
			    <b-card no-body class="mb-1">
			      <b-card-header header-tag="header" class="p-1" role="tab">
			        <b-btn block href="#" v-b-toggle.accordion2 variant="secondary" >Asistencia Sobre la Media</b-btn>
			      </b-card-header>
			      <b-collapse id="accordion2" accordion="my-accordion" role="tabpanel" class="alert alert-secondary">
			      	<b-card no-body>
					    <b-list-group flush>
					      <ItemGroup :datos="DatosItem" ind="75%" titulo="Sucursal 4" color="alert-secondary"></ItemGroup>
			    ...
			    <b-card no-body class="mb-1">
			      <b-card-header header-tag="header" class="p-1" role="tab">
			        <b-btn block href="#" v-b-toggle.accordion3 variant="danger">Asistencia Bajo</b-btn>
			      </b-card-header>
			      <b-collapse id="accordion3" accordion="my-accordion" role="tabpanel" class="alert alert-danger">
			         	<b-card no-body>
					    <b-list-group flush>
